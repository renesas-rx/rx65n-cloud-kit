 ...
 *         : 04.04.2019 2.41     Added support for GNUC and ICCRX.
 *                               Fixed coding style.
 **********************************************************************************************************************/
...
/* SCI0 */
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI0_SSCL0_PORT) && (('K') >= R_SCI_IIC_CFG_SCI0_SSCL0_PORT))
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI0_SSDA0_PORT) && (('K') >= R_SCI_IIC_CFG_SCI0_SSDA0_PORT))
...
/* SCI1 */
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI1_SSCL1_PORT) && (('K') >= R_SCI_IIC_CFG_SCI1_SSCL1_PORT))
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI1_SSDA1_PORT) && (('K') >= R_SCI_IIC_CFG_SCI1_SSDA1_PORT))
...
/* SCI2 */
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI2_SSCL2_PORT) && (('K') >= R_SCI_IIC_CFG_SCI2_SSCL2_PORT))
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI2_SSDA2_PORT) && (('K') >= R_SCI_IIC_CFG_SCI2_SSDA2_PORT))
...
/* SCI3 */
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI3_SSCL3_PORT) && (('K') >= R_SCI_IIC_CFG_SCI3_SSCL3_PORT))
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI3_SSDA3_PORT) && (('K') >= R_SCI_IIC_CFG_SCI3_SSDA3_PORT))
...
/* SCI4 */
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI4_SSCL4_PORT) && (('K') >= R_SCI_IIC_CFG_SCI4_SSCL4_PORT))
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI4_SSDA4_PORT) && (('K') >= R_SCI_IIC_CFG_SCI4_SSDA4_PORT))
...
/* SCI5 */
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI5_SSCL5_PORT) && (('K') >= R_SCI_IIC_CFG_SCI5_SSCL5_PORT))
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI5_SSDA5_PORT) && (('K') >= R_SCI_IIC_CFG_SCI5_SSDA5_PORT))
...
/* SCI6 */
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI6_SSCL6_PORT) && (('K') >= R_SCI_IIC_CFG_SCI6_SSCL6_PORT))
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI6_SSDA6_PORT) && (('K') >= R_SCI_IIC_CFG_SCI6_SSDA6_PORT))
...
/* SCI7 */
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI7_SSCL7_PORT) && (('K') >= R_SCI_IIC_CFG_SCI7_SSCL7_PORT))
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI7_SSDA7_PORT) && (('K') >= R_SCI_IIC_CFG_SCI7_SSDA7_PORT))
...
/* SCI8 */
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI8_SSCL8_PORT) && (('K') >= R_SCI_IIC_CFG_SCI8_SSCL8_PORT))
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI8_SSDA8_PORT) && (('K') >= R_SCI_IIC_CFG_SCI8_SSDA8_PORT))
...
/* SCI9 */
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI9_SSCL9_PORT) && (('K') >= R_SCI_IIC_CFG_SCI9_SSCL9_PORT))
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI9_SSDA9_PORT) && (('K') >= R_SCI_IIC_CFG_SCI9_SSDA9_PORT))
...
/* SCI10 */
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI10_SSCL10_PORT) && (('K') >= R_SCI_IIC_CFG_SCI10_SSCL10_PORT))
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI10_SSDA10_PORT) && (('K') >= R_SCI_IIC_CFG_SCI10_SSDA10_PORT))
...
/* SCI11 */
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI11_SSCL11_PORT) && (('K') >= R_SCI_IIC_CFG_SCI11_SSCL11_PORT))
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI11_SSDA11_PORT) && (('K') >= R_SCI_IIC_CFG_SCI11_SSDA11_PORT))
...
/* SCI12 */
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI12_SSCL12_PORT) && (('K') >= R_SCI_IIC_CFG_SCI12_SSCL12_PORT))
    ...
    #elif ((('J') <= R_SCI_IIC_CFG_SCI12_SSDA12_PORT) && (('K') >= R_SCI_IIC_CFG_SCI12_SSDA12_PORT))
