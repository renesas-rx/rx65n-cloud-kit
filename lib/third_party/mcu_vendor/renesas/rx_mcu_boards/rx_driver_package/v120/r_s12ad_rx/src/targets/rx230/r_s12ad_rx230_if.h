...
***********************************************************************************************************************/
/**********************************************************************************************************************
* File Name    : r_s12ad_rx230_if.h
* Description  : 12-bit A/D Converter driver interface file.
***********************************************************************************************************************
* History : DD.MM.YYYY Version Description
*           01.06.2016 1.00    Initial Release.
*           01.10.2016 2.20    Bug fix for R_ADC_Read can't read self-diag result.
*                              ADC_TRIG_SOFTWARE value changed.
*                              Delete unused define(ADC_CH0_TO_CH7 and ADC_CH16_TO_CH31).
*                              Delete unused member(S12CMPI priority level).
...
***********************************************************************************************************************/
#ifndef S12AD_RX230_IF_H
#define S12AD_RX230_IF_H
...
{
    adc_speed_t     conv_speed;      // ADCSR.ADHSC, rx230 has two conversion speeds
