...
* Version      : 1.12
* Device       : RX
* Abstract     : Specifics file dedicated to RX65N for QSPI single master drive
...
#define QSPI_SPDR_LONG(channel) (*g_qspi_base_adr[channel]).SPDR.LONG           /* QSPI Data Register
                                                                                                (Longword access)   */
#define QSPI_SPDR_BYTE(channel) (*(volatile uint8_t R_BSP_EVENACCESS_SFR *)(&(*g_qspi_base_adr[channel]).SPDR.LONG))
