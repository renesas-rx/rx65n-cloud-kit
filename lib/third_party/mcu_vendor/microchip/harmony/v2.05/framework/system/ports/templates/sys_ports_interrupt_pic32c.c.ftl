 ...
 *******************************************************************************/
 -->
<#macro SYS_PORT_ISR_HANDLER PORTS_CHANNEL>

void PORT${PORTS_CHANNEL}_Handler(void)
{
    /* System Ports Service Task routine */
    SYS_PORTS_Tasks(PORTS_CHANNEL_${PORTS_CHANNEL});
}
</#macro>
<#if CONFIG_SYS_PORTS_INST_IDX0 == true && CONFIG_SYS_PORT_A_INTERRUPT_USED == true>
<@SYS_PORT_ISR_HANDLER
PORTS_CHANNEL="A"
/>
</#if>
