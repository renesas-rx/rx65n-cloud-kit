...
#ifndef _DEVCON_JTAGENABLE_DEFAULT_1_H
#define _DEVCON_JTAGENABLE_DEFAULT_1_H

//******************************************************************************
/* Function :  DEVCON_JTAGPortEnable_Default_1
...
PLIB_TEMPLATE void DEVCON_JTAGPortEnable_Default_1( DEVCON_MODULE_ID index )
{
    *((SFR_TYPE *)(&DDPCON)) |=  1u<< _DDPCON_JTAGEN_POSITION;
}


//******************************************************************************
/* Function :  DEVCON_JTAGPortDisable_Default_1
...
PLIB_TEMPLATE void DEVCON_JTAGPortDisable_Default_1( DEVCON_MODULE_ID index )
{
    *((SFR_TYPE *)(&DDPCON)) &= ~(1 << _DDPCON_JTAGEN_POSITION);
}


//******************************************************************************
/* Function :  DEVCON_ExistsJTAGEnable_Default_1
...
PLIB_TEMPLATE bool DEVCON_ExistsJTAGEnable_Default_1( DEVCON_MODULE_ID index )
{
    return true;
}


#endif /*_DEVCON_JTAGENABLE_DEFAULT_1_H*/
