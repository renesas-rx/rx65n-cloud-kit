...
#ifndef _OSC_OSCSELECT_WK_H
#define _OSC_OSCSELECT_WK_H
...
#define OSC_USBPLL_UFIN_MAX						40000000
...
#define OSC_SYSPLL_UFIN_MIN						10000000
...
#define OSC_SYSPLL_UFIN_MAX						40000000


//******************************************************************************
/* Function :  OSC_ExistsOscSelect_wk

  Summary:
    Implements wk variant of PLIB_OSC_ExistsOscSelect

  Description:
    This template implements the wk variant of the PLIB_OSC_ExistsOscSelect function.
*/

#define PLIB_OSC_ExistsOscSelect PLIB_OSC_ExistsOscSelect
PLIB_TEMPLATE bool OSC_ExistsOscSelect_wk( OSC_MODULE_ID index )
{
    return true;
}
...
//******************************************************************************
/* Function :  OSC_SysClockSelect_wk

  Summary:
    Implements wk variant of PLIB_OSC_SysClockSelect 

  Description:
    This template implements the wk variant of the PLIB_OSC_SysClockSelect function.
*/

PLIB_TEMPLATE void OSC_SysClockSelect_wk( OSC_MODULE_ID index , OSC_SYS_TYPE newOsc )
{
    ...
    {
        SPLLCONSET = _SPLLCON_SPLLICLK_MASK;
    }
    else if ( newOsc == OSC_PRIMARY_WITH_PLL )
    {
        SPLLCONCLR = _SPLLCON_SPLLICLK_MASK;
