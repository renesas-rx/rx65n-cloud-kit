...
PLIB_TEMPLATE bool OSC_ExistsReferenceOscChangeActive_PIC32MX_XLP( OSC_MODULE_ID index )
{
    return true;
}
...
PLIB_TEMPLATE bool OSC_ReferenceOscSourceChangeIsActive_PIC32MX_XLP( OSC_MODULE_ID index , OSC_REFERENCE referenceOsc )
{
    return (bool)REFO1CONbits.ACTIVE;
}
