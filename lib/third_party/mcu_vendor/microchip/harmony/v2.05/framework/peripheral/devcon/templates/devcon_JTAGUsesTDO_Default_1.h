/*******************************************************************************
  ...
  File Name:
    devcon_JTAGUsesTDO_Default_1.h
...
#ifndef _DEVCON_JTAGUSESTDO_DEFAULT_1_H
#define _DEVCON_JTAGUSESTDO_DEFAULT_1_H

//******************************************************************************
/* Function :  DEVCON_2WireJTAGEnableTDO_Default_1
...
PLIB_TEMPLATE void DEVCON_2WireJTAGEnableTDO_Default_1( DEVCON_MODULE_ID index )
{
	DDPCONbits.TDOEN = 1;
}
...
//******************************************************************************
/* Function :  DEVCON_2WireJTAGDisableTDO_Default_1
...
PLIB_TEMPLATE void DEVCON_2WireJTAGDisableTDO_Default_1( DEVCON_MODULE_ID index )
{
	DDPCONbits.TDOEN = 0;
}
...
//******************************************************************************
/* Function :  DEVCON_ExistsJTAGUsesTDO_Default_1
...
PLIB_TEMPLATE bool DEVCON_ExistsJTAGUsesTDO_Default_1( DEVCON_MODULE_ID index )
{
    return true;
}
