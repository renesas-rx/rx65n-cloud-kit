...
typedef struct
{
    bool                     wilc1000EnabledEvents; // group enabled notification events
    volatile TCPIP_MAC_EVENT wilc1000PendingEvents; // group notification events that are set, waiting to be re-acknowledged
    TCPIP_MAC_EventF         wilc1000NotifyFnc; // group notification handler
    const void              *wilc1000NotifyParam; // notification parameter
