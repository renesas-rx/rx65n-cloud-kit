/*******************************************************************************
  ...
  File Name:
    drv_usart_definitions_pic32c.h
  ...
  Description:
    ...
    USART driver to manage the USART/UART module on PIC32C microcontrollers.
*******************************************************************************/
...
#ifndef _DRV_USART_DEFINITIONS_PIC32C_H
#define _DRV_USART_DEFINITIONS_PIC32C_H
...
#define DRV_USART_COUNT  /*DOM-IGNORE-BEGIN*/ USART_INST_NUM/*DOM-IGNORE-END*/
...
typedef enum
{
    ...
    /* This is the extension of normal point to point communication mode 
     * where the USART uses CTS and RTS lines to handshake for flow control */
...
typedef enum
{
    ...
    DRV_USART_LINE_CONTROL_8NONE1  
            /*DOM-IGNORE-BEGIN*/ = (US_MR_CHRL_8_BIT | US_MR_PAR_NO | US_MR_NBSTOP_1_BIT),/* DOM-IGNORE-END*/

    /* 9 data bits, no parity bit, 1 stop bit */
    DRV_USART_LINE_CONTROL_9NONE1  
            /*DOM-IGNORE-BEGIN*/ = (US_MR_PAR_NO | US_MR_NBSTOP_1_BIT), /* DOM-IGNORE-END*/

    /* 8 data bits, 1 bit for even parity, 1 stop bit */
    DRV_USART_LINE_CONTROL_8EVEN1  
            /*DOM-IGNORE-BEGIN*/ = (US_MR_CHRL_8_BIT | US_MR_PAR_EVEN | US_MR_NBSTOP_1_BIT), /* DOM-IGNORE-END*/

    /* 8 data bits, 1 bit for even parity, 2 stop bits */
    DRV_USART_LINE_CONTROL_8EVEN2  
            /*DOM-IGNORE-BEGIN*/ = (US_MR_CHRL_8_BIT | US_MR_PAR_EVEN | US_MR_NBSTOP_2_BIT),/* DOM-IGNORE-END*/

    /* 8 data bits, 1 bit for odd parity, 1 stop bit */
    DRV_USART_LINE_CONTROL_8ODD1   
            /*DOM-IGNORE-BEGIN*/ = (US_MR_CHRL_8_BIT | US_MR_PAR_ODD | US_MR_NBSTOP_1_BIT),/* DOM-IGNORE-END*/

    /* 8 data bits, 1 bit for odd parity, 2 stop bits */
    DRV_USART_LINE_CONTROL_8ODD2   
            /*DOM-IGNORE-BEGIN*/ = (US_MR_CHRL_8_BIT | US_MR_PAR_ODD | US_MR_NBSTOP_2_BIT),/* DOM-IGNORE-END*/

    /* 8 data bits, no parity bit, 2 stop bit */
    DRV_USART_LINE_CONTROL_8NONE2  
            /*DOM-IGNORE-BEGIN*/ = (US_MR_CHRL_8_BIT |  US_MR_PAR_NO | US_MR_NBSTOP_2_BIT),/* DOM-IGNORE-END*/

    /* 9 data bits, no parity bit, 2 stop bit */
    DRV_USART_LINE_CONTROL_9NONE2  
            /*DOM-IGNORE-BEGIN*/ =  (US_MR_PAR_NO | US_MR_NBSTOP_2_BIT)/* DOM-IGNORE-END*/
...
typedef struct
{
    ...
    /* Identifies USART hardware module ID. For a static build of
       the driver, this is overridden by DRV_USART_MODULE_ID macro in the
       system_config.h header file. */
    USART_MODULE_ID usartID;
    
    /* Identifies the Peripheral ID of PMC module. For a static build of
       the driver, this is overridden by DRV_USART_PMC_PERIPHERAL_ID macro in the
       system_config.h header file. */
    uint32_t PID;
    ...
    /* Interrupt source ID for the USART interrupt. For a static build of
       the driver, this is overridden by the DRV_USART_INT_SRC
    ...
    /* This is the USART transmit DMA channel trigger.
       For a static build of the driver, this is overridden by the
       DRV_USART_XMIT_DMA_CH_TRG_IDXn macro in system_config.h */
    ...
    /* This is the USART receive DMA channel trigger.
       For a static build of the driver, this is overridden by the
       DRV_USART_RCV_DMA_CH_TRG_IDXn macro in system_config.h */
...
#endif // #ifndef _DRV_USART_DEFINITIONS_PIC32_H
/*******************************************************************************
 End of File
*/
